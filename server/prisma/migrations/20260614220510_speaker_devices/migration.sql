...
INSERT INTO "new_Device" ("createdAt", "id", "isAudioSource", "lastSeenAt", "name", "pairedAt", "pairingCode", "pairingExpiresAt", "roomId", "schoolId", "tokenHash") SELECT "createdAt", "id", "isAudioSource", "lastSeenAt", "name", "pairedAt", "pairingCode", "pairingExpiresAt", "roomId", "schoolId", "tokenHash" FROM "Device";
DROP TABLE "Device";
...
CREATE TABLE "new_Recording" (
    ...
    "syncTone" BOOLEAN NOT NULL DEFAULT false,
    "layoutRole" TEXT,
    "layoutPosition" TEXT,
    "layoutScale" REAL,
...
INSERT INTO "new_Recording" ("completedAt", "cropH", "cropW", "cropX", "cropY", "deviceId", "hasAudio", "hasVideo", "id", "isAudioTrack", "layoutPosition", "layoutRole", "layoutScale", "lessonId", "mimeType", "receivedChunks", "segmentGroupId", "sizeBytes", "startedAt", "status") SELECT "completedAt", "cropH", "cropW", "cropX", "cropY", "deviceId", "hasAudio", "hasVideo", "id", "isAudioTrack", "layoutPosition", "layoutRole", "layoutScale", "lessonId", "mimeType", "receivedChunks", "segmentGroupId", "sizeBytes", "startedAt", "status" FROM "Recording";
